...
-- ConfigLibrary: stub on Solara since LoadConfigOnLaunch=false means it's never called
local ConfigLibrary do
	if identifyexecutor() ~= "Solara" then
		local ok, lib = pcall(function()
			return loadstring(game.HttpGet(game, "https://raw.githubusercontent.com/Exunys/Config-Library/main/Main.lua"))()
		end)
		ConfigLibrary = ok and lib or nil
	end
	ConfigLibrary = ConfigLibrary or {
		LoadConfig = function() return {} end,
		CloneTable = function(_, t) return t or {} end,
...
-- Solara supports Drawing.new("Quad") natively — skip remote DrawQuad fetch to avoid BLOCKED errors
