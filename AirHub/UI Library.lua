...
local decode = (syn and syn.crypt.base64.decode) or (crypt and crypt.base64decode) or (typeof(base64_decode) == "function" and base64_decode) or nil
local _ok, _gradient = pcall(function()
	if decode then
		return decode("")
	end
end)
...
function library.createcolorpicker(default, defaultalpha, parent, count, flag, callback)
	...
	local alphaicon = utility.create("Image", {
		...
		ZIndex = 9,
		Parent = icon,
		Data = decode and decode("iVBORw0KGgoAAAANSUhEUgAAABIAAAAKBAMAAABLZROSAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAGUExURb+/v////5nD/3QAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAVSURBVBjTY2AQhEIkliAWSLY6QQYAknwC7Za+1vYAAAAASUVORK5CYII=") or nil
	})
